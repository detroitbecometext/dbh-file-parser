...
namespace FileParser.Tests
{
    ...
    public class ExtractionServiceTests
    {
        ...
        public async Task Extract_With_No_Config_File_Should_Throw()
        {
            ...
            IExtractionService service = new ExtractionService(reporter, mockFileSystem, argumentsProvider);
        ...
        public async Task Extract_With_Key_Listing_Should_Work_Async()
        {
            ...
            IExtractionService service = new ExtractionService(reporter, testConfig.FileSystem, argumentsProvider);
